...
try:
    conn = pyodbc.connect(
        'DRIVER={SQL Server};SERVER=REVISION-PC\\SQLEXPRESS;DATABASE=Airline;Trusted_Connection=yes')
    ...
    def bookings_insert_data():
        ...
        start_date = datetime(2023, 12, 29, 1, 1, 1, 0)
