...
WHERE 
    CAST(F.DepartureTime AS DATE) = CAST(GETDATE() AS DATE ) AND Bookings.Status = 'Reserved';
...
-- Test Tickets CRUD
EXEC InsertTicket 'T001', 'Business', 'New York', 'London', 1500.00;
...
-- Test Bookings CRUD
DECLARE @PassengerId VARCHAR(10) = 'P001';
DECLARE @TicketId VARCHAR(50) = 'T001';
DECLARE @FlightId VARCHAR(250) = 'FL001';
